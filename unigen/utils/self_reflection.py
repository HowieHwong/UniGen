...
def reflection_improve_example(example,dataset_description,few_shot_des,constraint):
    ...
    if (isgood):
        ...
        print('----------------------------Example Need to be Improved----------------------------',
                "GREEN")
        print(example["text"])
        print("------------------------------------------------------------------------------------",
                "GREEN")
        ...
        print('----------------------------Example After Improvement-----------------------------', "GREEN")
        print(example["text"])
        print("----------------------------------------------------------------------------------", "GREEN")
...
def self_reflection(examples, dataset_description,few_shot_des,constraint, max_reflection=5,):
    with ThreadPoolExecutor(max_workers=len(examples)) as executor:
        futures = [executor.submit(reflect_single_example, example, dataset_description, few_shot_des,constraint,max_reflection) for example in examples]
        results = []
...
def reflect_single_example(example, dataset_description,few_shot_des,constraint, max_reflection):
    try:
        ...
        for epoch in range(max_reflection):
            print(f'----------------------------Self Reflection(Epoch{epoch})----------------------------', "GREEN")
        ...
        if not isgood:
            ...
            example['reflection_trajectory']=reflection_list
            print('----------------------------The Example is not good after the last epoch----------------------------',"GREEN")
        return example
